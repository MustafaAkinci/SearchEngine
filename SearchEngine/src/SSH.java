...
public class SSH {
	...
	public SSH(float load_factor,int col_alg,int table_size) {
	...
	public Node searchWord(String value) {
		...
		if(this.collision_algorithm == 0) {
			...
			//System.out.println("Searching time of SSH LP : " + ((System.nanoTime() - time)/1000000000) + " sec.");
			...
			//System.out.println("Searching time of SSH DH : " + ((System.nanoTime() - time)/1000000000) + " sec.");
